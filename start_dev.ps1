...
Set-Location "c:\Users\shaun\OneDrive\Desktop\olmies ai"
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd 'c:\Users\shaun\OneDrive\Desktop\olmies ai\src\Olmies.Api'; dotnet run"

# 4. Start Expo in a new PowerShell window
Write-Host "3. Starting Expo Mobile App (Web Mode) in a new window..."
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd 'c:\Users\shaun\OneDrive\Desktop\olmies-mobile'; npm run web"
